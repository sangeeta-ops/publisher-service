...
public class ProducerControllerIntegrationTest {
	...
	public void testAuthorizationWhenPassingValidToken() throws Exception {
		...
		mockMvc.perform(
				post("/publisher/publish-message").contentType(MediaType.APPLICATION_JSON).header("Activity-Id", "demo")
...
//		params.add("authorized_grant_types", "client_credentials authorization_code implicit refresh_token");
